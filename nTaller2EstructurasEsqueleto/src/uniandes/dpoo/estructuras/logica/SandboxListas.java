...
public class SandboxListas
{
    ...
    {
    	List<String> copia = new LinkedList<String>(listaCadenas);
    	return copia;    
    }
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	{
    		this.listaEnteros.add(getCantidadEnteros(), entero);
    	}
    	else
    	{
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	...
    	{
    		nuevoArreglo.add((int) valores[i]); 
    	}
    	this.listaEnteros=nuevoArreglo;
    }
    ...
    {
    	LinkedList<String> nuevoArreglo= new LinkedList<String>();
    	for (Object valor:objetos)
    	{
    		nuevoArreglo.add(valor.toString()); 
    	}
    	this.listaCadenas=nuevoArreglo;
    }
    ...
    public void organizarEnteros( )
    {
        ...
        for (int i = 0; i < tamaño - 1; i++) 
        {
            ...
            {
                if (this.listaEnteros.get(j) > this.listaEnteros.get(maximo)) 
                {
                    maximo = j;
                }
            }
            soporte = this.listaEnteros.get(i);
            this.listaEnteros.set(i, this.listaEnteros.get(maximo));
            this.listaEnteros.set(maximo, soporte);
   			}
    }
    ...
    public void organizarCadenas( )
    {
        ...
        for (int i = 0; i < tamaño - 1; i++) 
        {
            ...
            for (int j = i + 1; j < tamaño; j++) 
            {
                if (this.listaCadenas.get(j).compareTo(this.listaCadenas.get(minimo))<0) 
                {
                    minimo = j;
                }
            }
            soporte = this.listaCadenas.get(i);
            this.listaCadenas.set(i, this.listaCadenas.get(minimo));
            this.listaCadenas.set(minimo, soporte);
   			}
    }
    ...
    {
    	int apariciones =0;
    	for (String caracter:listaCadenas)
    	{
    		if(caracter.toLowerCase().equals(cadena.toLowerCase()))
    		{
    			apariciones++;
    		}
    	}
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (Integer valor: this.listaEnteros)
        {
        	if(!recorrido.contains(valor))
        	{
        		recorrido.add(valor);
        	}
        }
        for (Integer enteros: recorrido)
        {
        	if (contarApariciones(enteros)>1)
        	{
        		repetidos++;
        	}
        }
    ...
    {
    	ArrayList<Integer> enterosGenerados = new ArrayList<Integer>();
    	for (int i =0; i<cantidad;i++)
    	{
    		enterosGenerados.add((int) (Math.random()*(maximo-minimo+1))+minimo);
    	}
    	this.listaEnteros=enterosGenerados;
    }
